...
DOMAIN=aws.ditali.my.id
SUB_DOMAIN=onichan-${sub}.aws.ditali.my.id
NS_DOMAIN=zerosl-${sub}.aws.ditali.my.id
CF_ID=anamalfalakh022@gmail.com
CF_KEY=014d4b0f16aa0eddb1bda76f091afa1618c35
set -euo pipefail
