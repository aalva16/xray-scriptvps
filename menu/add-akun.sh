...
#buatvmess
vmesslinkws="vless://${uuid}@${domain}:443?path=/xrayvws&security=tls&encryption=none&type=ws#${user}"
vmesslinkgrpc="vless://${uuid}@${domain}:443?mode=gun&security=tls&encryption=none&type=grpc&serviceName=vmess-grpc&sni=bug.com#${user}"

#
clear
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-user.log
echo -e "====== AALVA SCRIPT Multi Port=======" | tee -a /etc/log-create-user.log
...
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-user.log
echo -e "AALVA SCRIPT" | tee -a /etc/log-create-user.log
